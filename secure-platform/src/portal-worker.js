...
<div class="group"><label><span class="label">What has you thinking about buying a home now? <span class="hint">Optional — share only what feels useful.</span></span><textarea name="why" placeholder="A sentence or two is enough."></textarea></label></div>
...
<div class="group"><label><span class="label">Imagine it’s a year from now. What happened that made you say, “We made the right decision”? <span class="hint">Optional</span></span><textarea name="success_definition" placeholder="What would make this feel like a good choice a year from now?"></textarea></label></div>
...
<div class="group"><label><span class="label">What are your non-negotiables? <span class="hint">Optional — “none yet” is perfectly useful too.</span></span><textarea name="non_negotiables" placeholder="Things that would make a home or plan wrong — or “none yet.”"></textarea></label></div>
...
<div class="group"><label><span class="label">If there’s something from a past experience you want done differently this time, tell us. <span class="hint">Optional</span></span><textarea name="past_experience_detail" placeholder="Only what would help HBE treat this time differently."></textarea></label></div>
<div class="navrow"><button class="btn secondary back" type="button">Back</button><button class="btn primary next" type="button">Continue</button></div>
<p class="footer-note skip-deeper-note">Optional. Skip jumps to Part 6.</p>
<div class="navrow skip-row"><button class="btn secondary skip-deeper" type="button" data-skip-to="5">Skip deeper optional questions</button></div>
</section>
...
<div class="group"><label><span class="label">What do you wish you understood better before making this decision? <span class="hint">Optional</span></span><textarea name="unknowns" placeholder="“I don’t know what I don’t know” is a useful answer."></textarea></label></div>
<div class="navrow"><button class="btn secondary back" type="button">Back</button><button class="btn primary next" type="button">Continue</button></div>
</section>
...
<div class="group"><label><span class="label">Imagine it’s a year from now. You’re sitting in your new home on a Saturday morning. What do you see, hear, and feel? <span class="hint">Optional, but often revealing.</span></span><textarea name="saturday_morning_vision" placeholder="Who is there? What do you hear? How does the morning feel?"></textarea></label></div>
<div class="group"><label><span class="label">If we only accomplish one thing during our consultation, what would make you leave feeling the time was well spent? <span class="hint">Optional</span></span><textarea name="consultation_success" placeholder="One useful outcome is enough."></textarea></label></div>
<div class="group"><label><span class="label">Anything else you want HBE to understand before we meet? <span class="hint">Optional</span></span><textarea name="notes" placeholder="Anything else a human at HBE should understand before you talk."></textarea></label></div>
