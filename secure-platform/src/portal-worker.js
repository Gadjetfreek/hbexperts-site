...
<p class="intro">These questions help HBE understand what matters to you and how to support your choices. There are no right answers.</p>
<div class="privacy"><strong>Nothing is sent to HBE yet.</strong> Your draft stays in this browser until you deliberately Review &amp; Send to HomeBuyer Experts.<br><br><strong>Reflective questions are optional.</strong> Share what feels useful, skip what does not, or choose “Prefer not to answer.” Skipping will not reduce the quality of HBE representation or service.</div>
...
<div class="group"><label><span class="label">What has you thinking about buying a home now? <span class="hint">Optional — share only what feels useful.</span></span><textarea name="why" placeholder="Example: We need more space for how we actually live — or say you’re still figuring that out."></textarea></label></div>
...
<div class="group"><label><span class="label">Imagine it’s a year from now. What happened that made you say, “We made the right decision”? <span class="hint">Optional</span></span><textarea name="success_definition" placeholder="Example: We felt settled and the house still fits our life."></textarea></label></div>
...
<div class="group"><label><span class="label">What are your non-negotiables? <span class="hint">Optional — “none yet” is perfectly useful too.</span></span><textarea name="non_negotiables" placeholder="Example: Commute must work; budget ceiling is real — or “none yet.”"></textarea></label></div>
...
<p class="intro">These questions help us communicate in a way that fits you. They are not a personality test.</p>
...
<div class="navrow"><button class="btn secondary back" type="button">Back</button><button class="btn primary next" type="button">Continue</button></div>
<p class="footer-note skip-deeper-note">Optional reflection. Skip jumps to Part 6 (life behind the home).</p>
...
<div class="navrow"><button class="btn secondary back" type="button">Back</button><button class="btn primary next" type="button">Continue</button></div>
<p class="footer-note skip-deeper-note">Optional. Skip jumps to Part 6.</p>
<div class="navrow skip-row"><button class="btn secondary skip-deeper" type="button" data-skip-to="5">Skip deeper optional questions</button></div>
</section>
...
<div class="group"><label><span class="label">If there’s something from a past experience you want done differently this time, tell us. <span class="hint">Optional</span></span><textarea name="past_experience_detail" placeholder="Example: Want less pressure this time — or “first-time buyer.”"></textarea></label></div>
<div class="navrow"><button class="btn secondary back" type="button">Back</button><button class="btn primary next" type="button">Continue</button></div>
<p class="footer-note skip-deeper-note">Optional. Skip jumps to Part 6.</p>
<div class="navrow skip-row"><button class="btn secondary skip-deeper" type="button" data-skip-to="5">Skip deeper optional questions</button></div>
</section>
...
<p class="intro">Useful starting points — you do not need exact answers yet.</p>
...
<div class="group"><label><span class="label">What do you wish you understood better before making this decision? <span class="hint">Optional</span></span><textarea name="unknowns" placeholder="Example: I don’t know what I don’t know — financing details, which areas fit."></textarea></label></div>
<div class="navrow"><button class="btn secondary back" type="button">Back</button><button class="btn primary next" type="button">Continue</button></div>
</section>
...
<div class="group"><label><span class="label">Imagine it’s a year from now. You’re sitting in your new home on a Saturday morning. What do you see, hear, and feel? <span class="hint">Optional, but often revealing.</span></span><textarea name="saturday_morning_vision" placeholder="Example: Coffee, quiet, sunlight — kids nearby, unhurried."></textarea></label></div>
<div class="group"><label><span class="label">If we only accomplish one thing during our consultation, what would make you leave feeling the time was well spent? <span class="hint">Optional</span></span><textarea name="consultation_success" placeholder="Example: Leave with a clear next step — or know if HBE is a fit."></textarea></label></div>
<div class="group"><label><span class="label">Anything else you want HBE to understand before we meet? <span class="hint">Optional</span></span><textarea name="notes" placeholder="Example: I’d rather discuss this live — or “nothing else right now.”"></textarea></label></div>
